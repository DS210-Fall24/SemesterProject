...
**Note:**  When you are done with your project, knit one last time to create the .md file that is readable on github if you want:  Click the arrow next to **Knit** and select **Knit to github_document**.
